...
class RoleValidationFilter implements FilterInterface
{
    ...
    public $rol_permisos = array(
        ...
        '4' => array('usuarios', 'homeCliente', 'usuarios', 'altaVehiculo', 'altaNuevoVehiculo', 'desestacionarV', 'desestacionarVehiculo','estacionarGuardaVehiculo','estacionarVehiculo','estacionarPendiente','venderEstadiaPendiente'),
    );
