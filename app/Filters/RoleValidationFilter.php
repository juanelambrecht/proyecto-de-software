...
class RoleValidationFilter implements FilterInterface
{
    ...
    public $rol_permisos = array(
        ...
        '4' => array('usuarios', 'api', 'precio', 'homeCliente', 'usuarios', 'altaVehiculo', 'altaNuevoVehiculo', 'desestacionarV', 'desestacionarVehiculo', 'estacionarGuardaVehiculo', 'estacionarVehiculo', 'comprarNuevaEstadia', 'estacionarIndefinido', 'venderEstadiaIndefinido', 'estacionarNuevoPendiente', 'estacionarPendiente'),
    );
